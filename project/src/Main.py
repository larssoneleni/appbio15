...
for i in range(len(file_path_list)):
    ...
    onlyfiles = []
    AllFiles = []
    files = listdir('/home/4/u1we1f44/Documents/appbio15/project/data/'+file_path)
    ...
    for j in range(len(onlyfiles)):
        try:
            ...
            fil = open('/home/4/u1we1f44/Documents/appbio15/project/data/'+path, 'r')
            ...
            ##
            line = 'cat /home/4/u1we1f44/Documents/appbio15/project/data/'+path+' | fastprot -I fasta -O phylip | fnj -I phylip -O "newick" -o "Treeout.txt"' 
            os.system(line)
            TreePath=file_path+'/'+RefTree   
            t1=Tree.get(file=open('/home/4/u1we1f44/Documents/appbio15/project/data/'+TreePath,'r'),schema="newick",tree_offset=0)
            t2=Tree.get(file=open('/home/4/u1we1f44/Documents/appbio15/project/src/Treeout.txt','r'),schema="newick",tree_offset=0,taxon_namespace=t1.taxon_namespace)
            ...
            os.system(line)
            TreePath=file_path+'/'+RefTree   
            tree1=Tree.get(file=open('/home/4/u1we1f44/Documents/appbio15/project/data/'+TreePath,'r'),schema="newick",tree_offset=0)
            tree2=Tree.get(file=open('/home/4/u1we1f44/Documents/appbio15/project/src/ReducingTreeout.txt','r'),schema="newick",tree_offset=0,taxon_namespace=tree1.taxon_namespace)
            tree1.encode_bipartitions()
            tree2.encode_bipartitions() 
            if treecompare.symmetric_difference(tree1, tree2)==0:
                FixedCount += 1
		os.remove('/home/4/u1we1f44/Documents/appbio15/project/src/ReducingTreeout.txt')
                os.remove('/home/4/u1we1f44/Documents/appbio15/project/src/temp.fa') 	
	    else:
		os.remove('/home/4/u1we1f44/Documents/appbio15/project/src/ReducingTreeout.txt')
                os.remove('/home/4/u1we1f44/Documents/appbio15/project/src/temp.fa')  
